...
import {TARGET_FPS, MOTE_BASE_SPEED, MOTE_BASE_SIZE, MOTE_BASE_SIGHT, PREGNANT_THRESHOLD, 
				DEATH_THRESHOLD, GLOBAL_DRAG, PREGNANT_TIME, DEBUG, MAX_MOTES/*, POSITIVE_ENERGY, NEGATIVE_ENERGY*/, TYPE_PHOTON} from "../constants"
import * as vectrix from "@nphyx/vectrix"
import {BooleanArray} from "@nphyx/pxene"
import {VanderPool} from "@nphyx/vanderpool"
import {avoid, accelerate, drag, twiddleVec, adjRand, posneg, outOfBounds, rotate, norm_ratio} from "../util"
...
const BUFFER_POOL = new VanderPool(BUFFER_LENGTH, MAX_MOTES)
